...
Python e incluam funções trigonométricas no projeto.
    1. Calculadora implementada no site Python Brasil, disponível em:
    https://wiki.python.org.br/CalculadoraSimplesTk
'''
from tkinter import *
from math import *
import sys
...
class Calculadora:
    def __init__(self, toplevel):
        ...
        # Botão seno
        seno = Button(self.frame4, font=fonte1, text='Sen', command=self.seno)
        seno.pack(side=LEFT)

        # Botão coseno
        coseno = Button(self.frame4, font=fonte1, text='Cos', command=self.coseno)
        coseno.pack(side=LEFT)
        ...
        self.box1 = Label(self.frame2, text='Valor1 :', font=fonte1, width=8).pack(side=LEFT)
        ...
        self.box2 = Label(self.frame3, text='Valor2 :', font=fonte1, width=8).pack(side=LEFT)
